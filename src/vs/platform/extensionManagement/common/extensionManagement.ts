	...
	.registerConfiguration({
		...
		properties: {
			[AllowedExtensionsConfigKey]: {
				...
				default: { '*': true, 'ms-vscode-remote.remote-ssh': false, 'ms-vscode-remote.remote-ssh-edit': false, 'ms-vscode.remote-explorer': false, 'ms-vscode-remote.remote-containers': false, 'ms-vscode-remote.remote-wsl': false, 'ms-vscode.remote-tunnels': false, 'ms-python.vscode-pylance': false },
				defaultSnippets: [{
					body: {},
