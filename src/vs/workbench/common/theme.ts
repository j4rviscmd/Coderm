...
export const EDITOR_GROUP_ACTIVE_BORDER = registerColor('editorGroup.activeBorder', {
	...
	hcDark: contrastBorder,
	hcLight: contrastBorder
}, localize('editorGroupActiveBorder', "Border color of the active editor group when the active pane border is enabled. Defaults to the theme's focus border color."));
